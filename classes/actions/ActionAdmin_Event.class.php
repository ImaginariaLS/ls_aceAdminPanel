...
class PluginAceadminpanel_ActionAdmin_Event extends PluginAceadminpanel_Inherit_ActionAdmin_Event
{
    ...
    protected $sMenuItemSelect; // Главное меню
    protected $sMenuSubItemSelect; // Активное меню
    protected $sMenuNavItemSelect; // Активное подменю
    protected $sUserLogin = null; // Навигационное меню
