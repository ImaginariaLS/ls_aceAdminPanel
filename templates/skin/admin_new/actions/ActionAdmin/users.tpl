                    ...
                    <div class="accordion-body collapse" id="admin_user_unban">
                        <form method="post" action="{$sFormAction}" class="well well-small">
                            ...
                            {if $oUserProfile->getBanLine()}
                                {$oLang->_adm_ban_upto} {$oUserProfile->getBanLine()}
                                <br/>
                            {else}
            ...
            <div class="accordion-group no-border">
                ...
                <div class="accordion-body collapse collapse-save" id="admin_form_seek_div">
                    <form method="post" action="{router page='admin'}users/" id="admin_form_seek"
                        ...
                        <button type="submit" name="adm_action_submit"
                                class="btn btn-primary">{$oLang->_adm_seek}</button>
                    ...
                    <form method="post" action="" class="well well-small">
                        ...
                        <div class="row">
                            ...
                            <span id="send_separate_notice"
                                  class="help-block">{$oLang->_adm_send_separate_notice}</span>
                        </div>
    ...
    <div id="adm_users_del_confirm" class="modal hide fade">
        ...
        <div class="modal-footer">
            ...
            <a href="#" class="btn btn-danger"
               onclick="return $ace.user.deleteSubmit(true);">{$oLang->_adm_users_del}</a>
        </div>
    </div>
{/block}
